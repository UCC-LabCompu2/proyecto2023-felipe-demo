...
function mostrarDatos(){
    var mostrar_nombretorneo = localStorage.getItem("nombretorneo");              //creo variables para guardar los datos ingresados en el formulario de toma_de_datos.html
    var mostrar_juego = localStorage.getItem("juego");
    var mostrar_cantidadparticipantes = JSON.parse(localStorage.getItem("renglon"));
...
function dibujarParticipantes(){
    ...
    var arreglo_participantes = JSON.parse(localStorage.getItem("renglon"));        //Uso JSON.parse para obtener el arreglo con los participantes
